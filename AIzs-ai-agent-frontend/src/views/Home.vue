<template>
  <div class="home-container">
    ...
    <div class="apps-container">
      ...
      <div class="app-card" @click="navigateTo('/company-policy')">
        <div class="card-glow"></div>
        <div class="app-icon policy-icon">📋</div>
        <div class="app-info">
          <div class="app-title">规章制度问答</div>
          <div class="app-desc">智能查询公司政策，快速获取制度信息</div>
        </div>
        <div class="app-button">
          <span class="btn-text">立即体验</span>
          <span class="btn-icon">→</span>
      ...
      <div class="app-card" @click="navigateTo('/pdf-chat')">
        <div class="card-glow"></div>
        <div class="app-icon pdf-icon">📄</div>
        <div class="app-info">
          <div class="app-title">PDF文档问答</div>
          <div class="app-desc">上传PDF文件，智能分析文档内容</div>
        </div>
        <div class="app-button">
          <span class="btn-text">立即体验</span>
          <span class="btn-icon">→</span>
